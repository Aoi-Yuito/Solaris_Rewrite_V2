...
async def gateway__gatetext(ctx, channel, value):
    ...
    if value is None:
        ...
        lc = await retrieve.log_channel(ctx.bot, channel.guild_id)
        await lc.send(f"{ctx.bot.info} The gate message text has been set to the following: {value}")
...
async def gateway__welcometext(ctx, channel, value):
    ...
    if value is None:
        ...
        lc = await retrieve.log_channel(ctx.bot, channel.guild_id)
        await lc.send(f"{ctx.bot.info} The welcome message text has been set to the following: {value}")
...
async def gateway__goodbyetext(ctx, channel, value):
    ...
    if value is None:
        ...
        lc = await retrieve.log_channel(ctx.bot, channel.guild_id)
        await lc.send(f"{ctx.bot.info} The goodbye message text has been set to the following: {value}")
...
async def gateway__welcomebottext(ctx, channel, value):
    ...
    if value is None:
        ...
        lc = await retrieve.log_channel(ctx.bot, channel.guild_id)
        await lc.send(f"{ctx.bot.info} The welcome bot message text has been set to the following: {value}")
...
async def gateway__goodbyebottext(ctx, channel, value):
    ...
    if value is None:
        ...
        lc = await retrieve.log_channel(ctx.bot, channel.guild_id)
        await lc.send(f"{ctx.bot.info} The goodbye bot message text has been set to the following: {value}")
